...
public abstract class VoxelGraph : MonoBehaviour {
    ...
    public void OnPropertiesChanged() {
        ...
        if (visualizer != null) {
            //executor.ExecuteShader(visualizer.size, Vector3.zero, Vector3.one, true);
    ...
    public string Transpile() {
        ...
        lines.Add("#include \"Assets/Terrain/Graph-To-Code/Runtime/Compute/Noises.cginc\"");
        lines.Add("#include \"Assets/Terrain/Graph-To-Code/Runtime/Compute/SDF.cginc\"");
        lines.Add("#include \"Assets/Terrain/Graph-To-Code/Runtime/Compute/Other.cginc\"");
